...
export class Command {
  ...
  createVltBase() {
    if ( atom.config.get('vlt-atom.vltBase', '').endsWith( CONTEXT.pathSeparator ) ) {
      return atom.config.get('vlt-atom.vltBase', '') + "bin" + CONTEXT.pathSeparator + "vlt";
    } else {
      return atom.config.get('vlt-atom.vltBase', '') +
